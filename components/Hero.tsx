  ...
  <div className="w-[80%] grid-cols-1 mx-auto grid lg:grid-cols-2 gap-[3rem] h-[100%] items-center p-[1rem]">
    ...
    <div className="pt-[2rem]">
      ...
      <p className="mt-[1.5rem] text-[18px] text-[#ffffff92]">
        With a strong foundation in HTML, CSS, JavaScript, Node.js, TypeScript,
        and MySQL, I create dynamic, responsive, and user-friendly websites and
        applications. My focus is on writing clean, efficient code and crafting
        seamless user experiences. I'm always eager to learn and adapt to new
        technologies, striving to push the boundaries of web development.
      </p>
    </div>
