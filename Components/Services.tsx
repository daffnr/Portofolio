...
const Services= ({id}:any) => {
  return (
    <div id={id} className="bg-[#121212] pt-[4rem] md:pt-[8rem] pb-[5rem]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-[80%] mx-auto items-enter gap-[3rem] mt-[4rem] text-white">
        <div>
          <div className="bg-red-700 hover:scale-110 transform transition-all duration-300 hover:-rotate-6 uppercase font-semibold text-center p-[2rem]">
            ...
            <p className="text-[15px] text-[#d3d2d] font-normal">
              I create responsive, user-friendly interfaces with HTML, CSS, and
              JavaScript. Using frameworks like React and Vue.js, I focus on
        ...
        <div>
          <div className="bg-orange-700 hover:scale-110 transform transition-all duration-300  uppercase font-semibold text-center p-[2rem]">
            ...
            <p className="text-[15px] text-[#d3d2d] font-normal">
              ...
              using MySQL. My expertise lies in creating well-structured
        ...
        <div>
          <div className="bg-blue-700 hover:scale-110 transform transition-all duration-300 hover:rotate-6 uppercase font-semibold text-center p-[2rem]">
            ...
            <p className="text-[15px] text-[#d3d2d] font-normal">
              ...
              applications. With expertise in HTML, CSS, JavaScript, Node.js,
              and MySQL, I create responsive, user-friendly interfaces and
